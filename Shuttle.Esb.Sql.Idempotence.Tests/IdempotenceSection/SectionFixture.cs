...
namespace Shuttle.Esb.Sql.Idempotence.Tests
{
	public class SectionFixture
	{
		...
		{
			return ConfigurationSectionProvider.OpenFile<IdempotenceSection>("shuttle", "idempotence", Path.Combine(AppDomain.CurrentDomain.BaseDirectory, string.Format(@".\IdempotenceSection\files\{0}", file)));
		}
