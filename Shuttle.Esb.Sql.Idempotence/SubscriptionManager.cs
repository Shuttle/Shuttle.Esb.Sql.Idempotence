...
namespace Shuttle.Esb.Sql.Idempotence
{
	public class SubscriptionManager : ISubscriptionManager
	{
	    ...
	    private readonly IIdempotenceConfiguration _configuration;
		...
		public SubscriptionManager(IServiceBusEvents events, IServiceBusConfiguration serviceBusConfiguration, IIdempotenceConfiguration configuration, IScriptProvider scriptProvider,
